...
<div class="col-lg-3">
	...
	{{ Form::model($continent,array('route' => array('continents.update', $continent->id),'method' => 'PUT')) }}
	...
	<a class="blue btn btn-default" href="{{URL::to('/continents/')}}"> Cancel </a>
...
<div class="modal fade" id="delete_bioss" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
	...
	<div class=" center col-lg-4">
		...
		{{ Form::model(
			$continent,
			array(
				'route' => array('continents.destroy', $continent->id),
