...
<div class="form-group"> <!-- _________________________________________________________________________ -->
	<label class=" col-sm-4 control-label " for="firstname_support">First Name </label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">

			{{ Form::text('firstname_support', '', array()); }}
...
<div class="form-group">
	<label class=" col-sm-4 control-label " for="lastname_support"> Last Name </label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">

			{{ Form::text('lastname_support', '', array()); }}
...
<div class="form-group">
	<label class=" col-sm-4 control-label " for="email_support"> Email </label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">

			{{ Form::text('email_support', '', array()); }}
...
<div class="form-group">
	<label class=" col-sm-4 control-label " for="phone_support">Phone</label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control">

			{{ Form::text('phone_support', '', array()); }}
