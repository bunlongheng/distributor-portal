...
<div class="form-group"> <!-- _________________________________________________________________________ -->
	<label class=" col-sm-4 control-label " for="firstname_sale">First Name </label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">
			{{ Form::text('firstname_sale', '', array()); }}
...
<div class="form-group">
	<label class=" col-sm-4 control-label " for="lastname_sale"> Last Name </label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">
			{{ Form::text('lastname_sale', '', array()); }}
...
<div class="form-group">
	<label class=" col-sm-4 control-label " for="email_sale"> Email </label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">
			{{ Form::text('email_sale', '', array()); }}
...
<div class="form-group">
	<label class=" col-sm-4 control-label " for="phone_sale">Phone</label>
	<div class="col-sm-8">
		<div class="input-group form-group float-label-control ">
			{{ Form::text('phone_sale', '', array()); }}
