...
if(Auth::check()){
    if ( Auth::user()->type == "Admin" ){
        ...
        //General
        Route::get('/activity', array('as' =>'activity','uses'=>'HomeController@activity'));
        ...
        //Route::get('distributors/list_view/image','DistributorController@list_view_image');
        ...
        // Product Uploads
        Route::get('product_uploads', array('as'=>'product_uploads.create', 'uses'=>'ProductUploadController@create'));
        Route::post('product_uploads/store','ProductUploadController@store');
        Route::get('product_uploads/{import_file}/progress','ProductUploadController@progress');
        Route::post('product_uploads/{import_file}/process','ProductUploadController@process');
        ...
        // Dist users.
        Route::get('distusers/{id}', array('uses'=>'DistUsers@index'));
        Route::get('distusers/{id}/create', array('uses'=>'DistUsers@createForm'));
        Route::Post('distusers/{id}/create', array('uses'=>'DistUsers@createFormSubmit'));
        Route::get('distusers/delete/{distId}/{userId}', array('uses'=>'DistUsers@delete'));
