$(document).ready(function(){
                ...
                $('#id-input-file-csv , #id-input-file-csv').ace_file_input({
                    no_file:'CSV File ...',
                    btn_choose:'Choose',
                    btn_change:'Change',
                    droppable:false,
                ...
                $('#id-input-file-zip , #id-input-file-csv').ace_file_input({
                    no_file:'ZIP File ...',
                    btn_choose:'Choose',
                    btn_change:'Change',
                    droppable:false,
                ...
                $('#id-input-file-xlsx , #id-input-file-xlsx').ace_file_input({
                    no_file:'Excel compatible File ...',
                    btn_choose:'Choose',
                    btn_change:'Change',
                    droppable:false,
                    onchange:null,
                ...
                $('#id-input-file-4').ace_file_input({
                    style:'well',
                    btn_choose:'Add Picture',
                    btn_change:null,
                    no_icon:'ace-icon fa fa-user',
                    droppable:true,
